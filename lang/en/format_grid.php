...
$string['sectiontitlesummarytextcolour_help'] = 'Set the the section title summary text colour when hovering over the grid box.';
$string['defaultsectiontitlesummarytextcolour'] = 'Set the section title summary text colour on hover';
$string['defaultsectiontitlesummarytextcolour_desc'] = 'Set the the section title summary text colour when hovering over the grid box.';
$string['top'] = 'Top';
