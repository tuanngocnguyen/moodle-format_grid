...
if ($ADMIN->fulltree) {
    ...
    // Default border colour in hexidecimal RGB with preceeding '#'.
    ...
    // Default imagecontainer background colour in hexidecimal RGB with preceeding '#'.
    ...
    // Default current selected section colour in hexidecimal RGB with preceeding '#'.
    ...
    // Default current selected imagecontainer colour in hexidecimal RGB with preceeding '#'.
